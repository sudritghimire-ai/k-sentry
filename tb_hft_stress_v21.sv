...
module tb_hft_stress_v21;
  ...
  task automatic run_sem_packet(input integer packet_id,input integer fault_kind);
    ...
    begin
      ...
      case(fault_kind)
        1: msgsB[pos1][7:0] = msgsB[pos1][7:0] + 8'd1;                              // 1 substitution
        2: begin msgsB[pos1][7:0] = msgsB[pos1][7:0] + 8'd3; msgsB[pos2][15:8] = msgsB[pos2][15:8] + 8'd5; end
        3: begin msgsB[pos1][7:0] = msgsB[pos1][7:0] + 8'd3; msgsB[pos2][15:8] = msgsB[pos2][15:8] + 8'd5;
                 msgsB[pos3][23:16] = msgsB[pos3][23:16] + 8'd9; end
        4: begin // adjacent transposition; force distinct if necessary
             if(msgsB[swap_pos]===msgsB[swap_pos+1]) msgsB[swap_pos][7:0] = msgsB[swap_pos][7:0] + 8'd1;
